...
template <> struct select_npy_type<int32_t> { const static NPY_TYPES type = NPY_INT; };
    ...
    template<> struct select_npy_type<int64_t> { static const int type_code = NPY_INT64; };
    template<> struct select_npy_type<uint64_t> { static const int type_code = NPY_UINT64; };
#endif
